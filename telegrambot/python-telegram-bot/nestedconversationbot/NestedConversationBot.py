"""
First, a few callback function are defined. Then, those functions are passed to 
the Apllication and registered at their respective places.
Then, the bot is started and runs untill we press Ctrl-C on the command line.

Usage:
Example of a bot-user conversation using nested ConversationHandlers.
Send /start to initiate the conversation.
Press Ctrl-C on the command line or send a signal to the proccess to stop the 
bot.
"""
...
# Diffrent constants for this example
(
    PARENTS,
    CHILDREN,
    SELF,
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> str:
    ...
    # If we're starting over we don't need send a new message
...
async def adding_self(update: Update, context: ContextTypes.DEFAULT_TYPE) -> str:
    """Adding information abot yourself."""
...
async def stop(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text("Okay, by.")
...
async def select_level(update: Update, context: ContextTypes.DEFAULT_TYPE) -> str:
    """Chose to add a parent or a child."""
    text = "You may add a parrent or a child. Also you can show the gathered data or go back."
    buttons = [
        [
...
async def select_gender(update: Update, context: ContextTypes.DEFAULT_TYPE) -> str:
    ...
    buttons = [
        ...
        [
            InlineKeyboardButton(text=f"Add {female}", callback_data=str(SHOWING)),
            InlineKeyboardButton(text="Back", callback_data=str(END)),
        ],
    ]
    keyboard = InlineKeyboardMarkup(buttons)
...
async def stop_nested(update: Update, context: ContextTypes.DEFAULT_TYPE) -> str:
    """Completely end conversation form within nested conversation."""
...
def main() -> None:
    ...
    application = (
        Application.builder()
        .token("7551740409:AAHAFH_unaEd1HZHKygeBpUlh_ychnJDxHI")
        .build()
    )
